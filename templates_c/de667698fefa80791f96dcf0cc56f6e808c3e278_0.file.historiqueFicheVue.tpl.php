<?php
/* Smarty version 4.2.1, created on 2023-09-06 21:47:56
  from 'C:\laragon\www\GourmandiseSarl\mvc-goo-12-HistoriqueCommande\mod_historique\vue\historiqueFicheVue.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_64f8f38ce87738_14221278',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de667698fefa80791f96dcf0cc56f6e808c3e278' => 
    array (
      0 => 'C:\\laragon\\www\\GourmandiseSarl\\mvc-goo-12-HistoriqueCommande\\mod_historique\\vue\\historiqueFicheVue.tpl',
      1 => 1694034897,
      2 => 'file',
    ),
  ),
...
function content_64f8f38ce87738_14221278 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a href="index.php?gestion=Historique">Historique</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
?>
                                        <tr>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getNumeroDeLigne();?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getReference();?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getDesignation();?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getQuantite();?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getTotalHT();?>
 €</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getPrixdevente();?>
 €</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['unHistorique']->value->getPrixTotal();?>
 €</td>
                                            <td>
                                                <form action="index.php" method="post">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="button" class="btn btn-submit" value="Retour"
                                               onclick="location.href='index.php?gestion=historique'">
