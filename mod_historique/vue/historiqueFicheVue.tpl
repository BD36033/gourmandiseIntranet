                        ...
                        <form action="index.php" method="POST">
                            ...
                            <div class="card-body card-block">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    {foreach from=$listeHistoriques item=unHistorique}
                                        <tr>
                                            <td>{$unHistorique->getNumeroDeLigne()}</td>
                                            <td>{$unHistorique->getReference()}</td>
                                            <td>{$unHistorique->getDesignation()}</td>
                                            <td>{$unHistorique->getQuantite()}</td>
                                            <td>{$unHistorique->getTotalHT()} €</td>
                                            <td>{$unHistorique->getPrixdevente()} €</td>
                                            <td>{$unHistorique->getPrixTotal()} €</td>
                                            <td>
                                                <form action="index.php" method="post">
                                                    <input type="hidden" name="numero" value="{$unHistorique->getNumero()}">
                                                    <input type="hidden" name="gestion" value="historique">
