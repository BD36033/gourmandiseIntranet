                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div {if HistoriqueTable::getMessageSucces () neq ''} class="alert alert-success" role="alert" {/if} >
                                {HistoriqueTable::getMessageSucces ()}
                            </div>
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                {foreach from=$listeHistoriques item=unHistorique}
                                    <tr>
                                        <td>{$unHistorique->getNumero()}</td>
                                        <td>{$unHistorique->getnomVendeur()}</td>
                                        <td>{$unHistorique->getCodec()}-{$unHistorique->getNomClient()}</td>
