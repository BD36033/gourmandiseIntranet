...
//$row est un TABLEAU
 ...
 // Getters
     ...
     * @return string
     */
    public function getPourcentageCA()
    {
     ...
     * @return string
     */
    public function getArticlePop()
    {
        return $this->ArticlePop;
    }
    /**
     * @return string
     */
    public function getQuantiteArticlePop()
    {
        return $this->QuantiteArticlePop;
    }
 ...
 // Setters
    ...
    /**
     * @param string $PourcentageCA
     */
    public function setCAtotal($PourcentageCA)
    {
        $this->PourcentageCA = $PourcentageCA;
    }
    /**
     * @param string $ArticlePop
     */
    public function setArticlePop(array $ArticlePop)
    {
        $this->ArticlePop = $ArticlePop;
    }
    /**
     * @param string $QuantiteArticlePop
     */
    public function setQuantiteArticlePop(array $QuantiteArticlePop)
    {
        $this->QuantiteArticlePop = $QuantiteArticlePop;
    }
    /**
